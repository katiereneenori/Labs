...
synth_design -top TopDatapath -part xc7a35tlcpg236-2L
...
write_checkpoint -force -noxdef TopDatapath.dcp
OPTRACE "write_checkpoint" END { }
OPTRACE "synth reports" START { REPORT }
create_report "synth_1_synth_report_utilization_0" "report_utilization -file TopDatapath_utilization_synth.rpt -pb TopDatapath_utilization_synth.pb"
