...
HD_PWD='C:/Users/tjwil/Desktop/ECE369A/LabsRepo/Labs/Lab4Files/Lab4.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log TopDatapath.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source TopDatapath.tcl -notrace
